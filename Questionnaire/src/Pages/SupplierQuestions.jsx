...
const SupplierQuestions = () => {
  ...
  const [supplierData, setSupplierData] = useState({
    Qs9a_Phone: "+358 13322",
    Qs9b_Cellphone: "+1 13882",
  });
  ...
  const connectToDatabase = async (e) => {
    ...
    upload.append("file", dilligenceFile);
    upload.append("file", issuedFairLaborEvidence);

    upload.append("file", issuedFairStoneEvidence);

    upload.append("file", issuedGlobalOrganicTextileEvidence);

    upload.append("file", issuedGrunerKnopfEvidence);

    upload.append("file", issuedIGEPEvidence);

    upload.append("file", issuedOEKOTEXGreenEvidence);

    upload.append("file", issuedSMETASedexEvidence);

    upload.append("file", issuedSocialAccountabilitySA8000);

    upload.append("file", issuedXertifixStandardEvidence);
    upload.append("file", issuedXertifixPlusEvidence);
    upload.append("file", issuedAMFORIBEPIEvidence);

    upload.append("file", issuedDINENISO14001Evidence);

    upload.append("file", issuedGrunerKnopfEvidence1);

    upload.append("file", issuedIGEP2020AuditEvidence);
    upload.append("file", issuedDINENISO45001Evidence);
    upload.append("supplierData", supplierData);

    // submitValue = e.nativeEvent.submitter.attributes.value.value;

    try {
      const response = await axios.post(
        `${process.env.REACT_APP_NODE_MIDDLEWARE}/supplier/`,
        upload,
        {
          headers: {
  ...
  const uploadDocuments = async () => {
    if (recordId !== 0) {
      try {
        const response = await axios.post(
          `${process.env.REACT_APP_NODE_MIDDLEWARE}/supplier/documents/`,
          upload,
          {
            headers: {
              ...
              <div className="form-field">
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    value={supplierData.Qs1_SupplierName}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs2_SuppBusinessLicenseNumber}
                    type="text"
                    onInput={(e) => {
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs3_SuppExportLicenseNumber}
                    type="text"
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs4_SuppVATNumber}
                    type="text"
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs5a_Building}
                    type="text"
                    name="Qs5a_Building"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs5b_Street}
                    type="text"
                    name="Qs5b_Street"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs6c_Province}
                    type="text"
                    name="Qs6c_Province"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    placeholder="Enter your answer"
                    type="text"
                    value={supplierData.Qs7_PostCode}
                    name="Qs7_PostCode"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                  />
                ...
                <div className="field-sections">
                  ...
                  <div className="form-group d-flex">
                    <select
                      value={supplierData.Qs9a_Phone.substring(
                        0,
                        supplierData.Qs9a_Phone.indexOf(" ")
                      )}
                      required
                      onChange={(e) => {
                    ...
                    <input
                      ...
                      type="text"
                      value={supplierData.Qs9a_Phone.substring(
                        supplierData.Qs9a_Phone.indexOf(" ") + 1
                      )}
                      required
                      onInput={(e) => {
                        e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                ...
                <div className="field-sections">
                  ...
                  <div className="form-group d-flex">
                    <select
                      className="form-control countryCode me-1"
                      id="countrySelect"
                      value={supplierData.Qs9b_Cellphone.substring(
                        0,
                        supplierData.Qs9b_Cellphone.indexOf(" ")
                      )}
                      required
                      onChange={(e) => {
                    ...
                    <input
                      ...
                      value={supplierData.Qs9b_Cellphone.substring(
                        supplierData.Qs9b_Cellphone.indexOf(" ") + 1
                      )}
                      pattern="[0-9]*"
                      name="Qs9b_Cellphone"
                      onChange={(e) => {
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs11_Website}
                    type="text"
                    name="Qs11_Website"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="form-select"
                    value={supplierData.Qs12a_salutation}
                    aria-label="Default select example"
                    onChange={(e) => {
                      setSupplierData({
                        ...supplierData,
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs12b_FirstName}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs12c_LastName}
                    type="text"
                    name="Qs12c_LastName"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs13_ContactPersonPosition}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    type="text"
                    value={supplierData.Qs14_YearOfEstablishment}
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="This value must be a number"
                    value={supplierData.Qs15_TotalNoOfEmployees}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9]/g, "");
                    }}
                    pattern="[0-9]*"
                ...
                <div className="field-sections">
                  ...
                  >
                    ...
                    <option value="Belongs to Group">Belongs to Group </option>
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs18_MainProducts}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    placeholder="This value must be a number"
                    type="text"
                    value={supplierData.Qs19_SalesPerYearDomestic}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                    pattern="[0-9]*"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    placeholder="This value must be a number"
                    type="text"
                    value={supplierData.Qs20_SalesPerYearExport}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                    pattern="[0-9]*"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs21_MainCustomerAndCountry}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs22_MainCustomerProducts}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs25_TradeFairParticipation}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    placeholder="This value must be a number"
                    type="text"
                    value={supplierData.Qs27_DeliveryLeadTimeInitialOrder}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                    pattern="[0-9]*"
                ...
                <div className="field-sections">
                  ...
                  <input
                    ...
                    placeholder="This value must be a number"
                    type="text"
                    value={supplierData.Qs28_DeliveryLeadTimeRepeatOrder}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                    }}
                    pattern="[0-9]*"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs29_BeneficiaryName}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs30_BankName}
                    type="text"
                    name="Qs30_BankName"
                    className="mt-3 outline-none w-100"
                    id="name-text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs31_BankAddress}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <div className="form-group d-flex">
                    ...
                    <input
                      ...
                      name="Qs33_BankPhone"
                      required
                      value={supplierData.Qs33_BankPhone}
                      placeholder="This value must be a number"
                      type="text"
                      onInput={(e) => {
                        e.target.value = e.target.value.replace(/[^0-9-]/g, "");
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs34_BankRegionalNumber}
                    type="text"
                ...
                <div className="field-sections">
                  ...
                  <input
                    onChange={handleChange}
                    placeholder="Enter your answer"
                    value={supplierData.Qs37_BeneficiaryBankACNumber}
                    type="text"
                ...
                <div className="field-sections" style={{ color: "lightgrey" }}>
                  <span>
                  ...
                  <div>
                    {supplierData.Qs122_NotUseManufactureSubstancesListedAnnexI ===
                      ...
                      <div className="field-sections">
                        ...
                        <input
                          required
                          value={supplierData.Qs123_SubstancesListedYESNO}
                          onChange={handleChange}
                          placeholder="Enter your answer"
                          type="text"
                  ...
                  <div className="field-sections">
                    ...
                    <span style={{ display: "flex", padding: "0px" }}>
                      ...
                      <p>
                        ...
                        right to conduct 3rd party audits to access and verify
                        our provided information.
                      </p>
                    </span>
                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      >
                        <p style={{ display: "flex" }}>
                          ...
                          />
                          <p>
                            We review all the pre-filled data and confirm there
                            is no change.
                          </p>
                        </p>
                      </span>
